...
export default function Home() {
  return (
    <div>
      <div className="flex items-center justify-center lg:m-[10vh] m-[5vh]">
        <div className="items-center w-[70vh]">
          <h2 className="font-bold text-3xl mb-[3vh]">Plan your journey now</h2>
          <p className='text-5xl font-semibold mt-5 mb-5'>Just <span class="text-[#655DBB]">focus</span> on roads </p>
        ...
        <div className="md:w-[800px] hidden md:flex xl:w-[1000px] bg-gradient-to-br from-[#655DBB] to-blue-100 rounded-[50%] p-8">
